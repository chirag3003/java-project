...
class LinkedList2 {
    ...
    public void joinNode(LinkedList2 list) {
        if (head == null){
            head = list.head;
            return;
        }
...
/*
    ...
    2. Define a LinkedList class with methods for inserting a node, deleting a node, joining two lists and  printing the list.
